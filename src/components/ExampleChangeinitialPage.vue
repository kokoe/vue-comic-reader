<template>
  <section>
    <h2 class="title is-2">
      Change Start Page
      <a class="pl-2" href="https://github.com/kokoe/vue-comic-reader/blob/main/src/components/ExampleChangeinitialPage.vue" target="_blank"><Icon icon-name="code-tags" /></a>
    </h2>
    <VueComicReader
